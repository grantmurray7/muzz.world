...
def parse_args():
    ...
    parser.add_argument("--min-latest-5s-block", type=float, default=0.05, help="Minimum latest 5s block percent")
    parser.add_argument("--min-latest-three-sum", type=float, default=0.12, help="Minimum sum of latest three 5s blocks percent")
    ...
    parser.add_argument("--spread-max", type=float, default=0.02, help="Maximum spread percent allowed")
    parser.add_argument("--min-top5-depth", type=float, default=25000.0, help="Minimum combined top5 book depth in USDC")
